...
const {addProduct,getProducts,deleteProduct,showUpdateProductPage,updateProduct,loadAddProductPage,toAproveProducts,approveProduct,rejectProduct,myProducts}=require("../controllers/ProductController");
...
productRoute.get("/myPostedProducts/:page",isSeller,myProducts);
