...
const {loadsellerhome,loadsellersignup,loadsellerLogin,signupseller,loginseller,verifyEmail,toAproveSellers,approveSeller,rejectSeller,loadOrderOut,loadMyProduct,logout,loadReportPage,monthlyReport,yearlyReport}=require("../controllers/sellerController");
...
sellerRoute.get("/report",isSeller,loadReportPage);
